...
class Collaborator extends TypedProxy {
  static Collaborator _cast(js.JsObject proxy) => proxy == null ? null : new Collaborator._fromProxy(proxy);

  Collaborator._fromProxy(js.JsObject proxy) : super.fromProxy(proxy);
